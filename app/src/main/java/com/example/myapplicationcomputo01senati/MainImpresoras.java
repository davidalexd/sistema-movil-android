...
public class MainImpresoras extends AppCompatActivity implements  AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_impresoras);
        Lista = (ListView) findViewById(R.id.lv2);
        Lista.setOnItemClickListener(this);

        imgproducto =(ImageView) findViewById(R.id.imgimpresora);
